...
const commentCtrl = {
   ...
   updateComment:async (req,res)=>{
    try {
        ...
        const cm= await Comments.findByIdAndUpdate({_id:req.params.id,user:req.user.id},
            {
                content
            })
...
deleteComment: async (req, res) => {
    ...
    $or:[{user:req.user.id},{postUserId:req.user._id}]})

    await Posts.findByIdAndUpdate({_id:comments.postId},{
